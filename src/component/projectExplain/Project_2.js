    ...
    if(number === 1 ){
            ...
            <div className="modalDetail">
                ...
                <p className="modalHalfSideTitle"> {titleSub1} </p>
                    <div className="modalHalfSideImageArea">
                        <img src={`${process.env.PUBLIC_URL}/img/WegoMainFunction.png`} className="modalHalfSideImage"></img>
                        <p className="modalHalfSideText"></p>
                    </div>
                </div>
                <div className="modalHalfSide">
        ...
        return(
            <div className="modalDetail">
                ...
                <p className="modalHalfSideTitle"> {titleSub1} </p>
                    <div className="modalHalfSideImageArea">
                        <img src={`${process.env.PUBLIC_URL}/img/WegoFunctionPlan.png`} className="modalHalfSideImage"></img>
