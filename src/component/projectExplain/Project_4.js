    ...
    if(number === 1 ){
        return(
            <div className="modalDetail">
                ...
                <p className="modalHalfSideTitle"> {titleSub1} </p>
                    <img src={`${process.env.PUBLIC_URL}/img/portfolioArchitecture.png`} className="modalHalfSideImage"></img>
                </div>
                <div className="modalHalfSide">
        ...
        return(
            <div className="modalDetail">
                ...
                <div className="modalHalfSide">
                <p className="modalHalfSideTitle"> {titleSub2} </p>
                    <img src={`${process.env.PUBLIC_URL}/img/portfolioDesign.png`} className="modalHalfSideImage"></img>
                </div>
            </div> 
        )
    }else if(number === 3){
